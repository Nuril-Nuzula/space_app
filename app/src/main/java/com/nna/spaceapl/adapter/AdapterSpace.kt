...
class AdapterSpace : RecyclerView.Adapter<SpaceViewHolder>() {
    private var listitemgalery = arrayListOf<SpaceItem>()

    fun addData(items : List<SpaceItem>){
        listitemgalery.addAll(items)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SpaceViewHolder {
        ...
        return SpaceViewHolder(listitemgallerybinding)
...
//        return GalleryViewHolder(view)
    ...
    override fun onBindViewHolder(holder: SpaceViewHolder, position: Int) {
        val data = listitemgalery[position]
